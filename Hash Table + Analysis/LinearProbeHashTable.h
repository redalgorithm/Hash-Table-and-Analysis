...
//------------------------------------------------
// LinearProbeHashTable (class)
//
//  Demonstration of more advanced OOP to
//  achieve a functional Linear Probe Hash Table
//  i = h(key)
//  if occupied, i = (i + 1) MOD N
//
// Private members: yes
...
//
// • Uses Linear Probing to search for an entry
//    with key k
//
...
//------------------------------------------------
template <typename Key, typename Element, typename HashCmp>
typename LinearProbeHashTable<Key, Element, HashCmp>::EntryPtr
...
//
// • Uses Linear Probing to insert a (key,element)
//   pair
//
